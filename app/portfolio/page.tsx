...
const PROJECTS = [
  {
    ...
    category: "Web App",
    color: "#D4A843",
    colorAlpha: "rgba(212,168,67,0.07)",
  ...
  },
  {
    ...
    num: "02",
    title: "DigiLearn",
    tagline: "100+ free courses for the AI era — web dev, data science, ethics, healthcare, and public policy.",
    status: "Live", year: "2026",
    category: "EdTech Platform",
    color: "#0284C7",
    colorAlpha: "rgba(2,132,199,0.07)",
    desc: "100+ courses across 12 categories built for people locked out of expensive platforms. AI tools, data science, databases, ethics, fintech, healthcare IT, and public policy — all completely free.",
  ...
  },
  {
    ...
    desc: "Download maps before you leave. Routes and terrain cached locally. Emergency contacts fire if you miss a waypoint check-in. Your GPS position goes to your contact — not a vague notification.",
  ...
  },
  {
    ...
    color: "#FF6B35",
    colorAlpha: "rgba(255,107,53,0.07)",
    desc: "Set a check-in interval, tap Start. If you miss a check-in, the alert chain runs: SMS to your emergency contact, then a call, then a second contact — with your GPS coordinates at every step.",
  ...
  },
  {
    ...
    color: "#00C8FF",
    colorAlpha: "rgba(0,200,255,0.07)",
    desc: "Log hours by task and site. Supervisors approve digitally with timestamps. One-click compliance PDF export formatted to each state's certificate board. TAFE assessors get a cohort dashboard — no chasing, no spreadsheets.",
