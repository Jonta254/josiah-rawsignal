...
const PROJECTS: Record<string, {
  ...
  forexpro: {
    title: "ForexPro",
    tagline: "A professional-grade forex platform — demo account, structured education, live trading, KYC, and deposit support.",
    role: "Product Designer + Full-Stack Developer",
    timeline: "Ongoing · 2025–2026",
    tools: ["Next.js 16", "TypeScript", "Prisma", "PostgreSQL", "Stripe", "Vercel"],
    status: "Live",
    accent: "#1E6BFF",
    accentRgb: "30,107,255",
    image: "/images/work-1.jpg",
    liveUrl: "https://fxprorise.org",
    challenge: "Most forex platforms either target professionals (too complex, too expensive for beginners) or retail traders (gamified, misleading, no real education). The gap is a platform that starts with learning, proves itself with a risk-free demo, then transitions naturally to live trading — with full deposit infrastructure and KYC compliance.",
    approach: [
      { step: "Learning before trading", detail: "Built 11 structured forex lessons — from how currency pairs work to risk management and technical analysis. Education is free and ungated, accessible before any account creation. The platform has to teach before it can earn trust." },
      { step: "Demo account with real infrastructure", detail: "$50,000 virtual demo with live market prices, full trade history, and a dashboard that mirrors the live trading experience. Users experience the real platform before committing capital." },
      { step: "Production-grade backend", detail: "Prisma ORM with PostgreSQL for user management, KYC document handling, trade records, deposit tracking, and withdrawal processing. Admin panel for operator control of deposits, withdrawals, and user KYC status. Stripe integration for card payments." },
    ],
    outcome: "Platform live at fxprorise.org. Full trading infrastructure: demo account with $50k virtual funds, live trading terminal with 10+ instruments (EUR/USD, Gold, BTC/USD, indices), KYC verification flow, multi-method deposits (card/crypto/wire), AI trading assistant, admin panel. 11 structured forex courses free to all visitors.",
    prev: "digilearn",
    next: "humanchain",
  },
  humanchain: {
